...
Router::connect('/admin/scoreengine', ['plugin' => 'ScoreEngine', 'controller' => 'admin', 'action' => 'index']);
Router::connect('/admin/scoreengine/:action/*', ['plugin' => 'ScoreEngine', 'controller' => 'admin']);
